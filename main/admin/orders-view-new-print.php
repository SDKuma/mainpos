                            ...
                            <div id="myBillingArea">
                                ...
                                if (isset($_GET['track'])) {
                                    if ($_GET['track'] == "") {
                                        ...
                                        echo "<tr><td colspan='4'  style='font-weight: bold;'>Discount:</td><td style='font-weight: bold;font-size:20px'>Rs." . number_format($order['total_amount']) . "</td></tr>";
                                        echo "<tr><td colspan='4'  style='font-weight: bold;'>Scrap Discount:</td><td style='font-weight: bold;font-size:20px'>Rs." . number_format($order['total_amount']) . "</td></tr>";
                                        echo "<tr><td colspan='4'  style='font-weight: bold;'>Net Grand Total:</td><td style='font-weight: bold;font-size:20px'>Rs. " . number_format($order['total_amount']) . "</td></tr>";
